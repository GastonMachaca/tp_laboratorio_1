...
Hacemos uso de las siguientes funciones del LinkedList:

- ll_isEmpty.
- ll_add.
- ll_get.
- ll_len.
- ll_sort (Menu.c - SubMenuOrdenar).
- ll_remove (Menu.c - SubMenuRemove).
- ll_
...
void controller_deleteEmployees(LinkedList* pArrayListEmployee)
{
    if(pArrayListEmployee != NULL)
    {
    ...
    {
        printf("No hay empleados para borrar.\n");
    }
}
